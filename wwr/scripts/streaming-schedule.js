document.addEventListener("DOMContentLoaded", function() {
    const streamingSchedule = document.getElementById("streaming-schedule");
    ...
    const games = ['Rocket League', 'Phasmophobia', 'Lethal Company', 'Roblox', 'Tarkov'];

    // Function to generate a random activity from the list of games
